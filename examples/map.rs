...
use burberry::{
    collector::MempoolHashesCollector, map_collector, map_executor, submit_action, ActionSubmitter,
...
async fn main() {
    ...
    let mempool_collector = MempoolHashesCollector::new(Arc::clone(&provider));
